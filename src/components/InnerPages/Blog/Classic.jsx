...
function Classic() {
  return (
    <section className="section-padding sub-bg">
              ...
              <p className="full">
                <Link href="/">
                  ...
                  >
                    <path
                      opacity="0.4"
                      d="M10.9366 17.5871L6.00434 18.0233C4.89744 18.0233 4 17.1171 4 15.9994C4 14.8817 4.89744 13.9756 6.00434 13.9756L10.9366 14.4118C11.805 14.4118 12.509 15.1226 12.509 15.9994C12.509 16.8777 11.805 17.5871 10.9366 17.5871Z"
                      fill="#000"
                    ></path>
                    <path
